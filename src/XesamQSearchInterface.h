...
#ifndef XESAMQSEARCHINTERFACE_H_1219764495
#define XESAMQSEARCHINTERFACE_H_1219764495
...
public Q_SLOTS: // METHODS
    ...
    inline QDBusReply<uint> GetHitCount(const QString &search_handle)
    {
        QList<QVariant> argumentList;
        argumentList << qVariantFromValue(search_handle);
    ...
    inline QDBusReply<QList<QVariantList> > GetHits(const QString &search_handle, uint count)
    {
        QList<QVariant> argumentList;
